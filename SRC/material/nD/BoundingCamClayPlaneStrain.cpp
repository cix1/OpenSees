...
//full constructor
BoundingCamClayPlaneStrain::BoundingCamClayPlaneStrain(int tag, double mDen, double C, double bulk,
                         double OCR, double mu_o, double alpha, double lambda, double h, double m) : 
